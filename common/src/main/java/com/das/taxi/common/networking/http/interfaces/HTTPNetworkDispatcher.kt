...
class HTTPNetworkDispatcher: HTTPNetworkDispatcherBase {
    ...
    override fun dispatch(path: String, params: Map<String, Any>?, completionHandler: (RemoteResponse<Any, HTTPStatusCode>) -> Unit) {
        GlobalScope.launch(Dispatchers.Main) {
            ...
            Log.d("urlConnection", result.toString())
        }
    }
    private suspend fun doIt(
            path: String, params: Map<String, Any>?): RemoteResponse<Any, HTTPStatusCode> = withContext(Dispatchers.IO) {
        ...
        Log.d("urlConnection",bts.toString())
        Log.d("urlConnectionOutputS",client.responseCode.toString())
