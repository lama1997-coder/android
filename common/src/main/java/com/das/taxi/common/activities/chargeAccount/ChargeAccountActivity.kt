package com.das.taxi.common.activities.chargeAccount
...
import com.das.taxi.common.databinding.ActivityChargeAccountBinding
import com.das.taxi.common.interfaces.AlertDialogEvent
import com.das.taxi.common.models.PaymentGateway
import com.das.taxi.common.models.PaymentGatewayType
import com.das.taxi.common.models.WalletItem
import com.das.taxi.common.networking.http.GetStripeClientSecret
import com.das.taxi.common.networking.http.StripeClientSecretEndpointResult
import com.das.taxi.common.networking.socket.WalletInfo
import com.das.taxi.common.networking.socket.WalletInfoResult
import com.das.taxi.common.networking.socket.WalletTopUp
import com.das.taxi.common.networking.socket.interfaces.EmptyClass
import com.das.taxi.common.networking.socket.interfaces.ErrorStatus
        ...
        WalletInfo().execute<WalletInfoResult> {
            when(it) {
                is RemoteResponse.Success -> {
                    Log.d("getwayAvilable", it.body.toString())
                    binding.loadingMode = false
                    if(it.body.gateways.count() < 1) {
                        AlertDialogBuilder.show(this@ChargeAccountActivity, getString(R.string.no_getway_availabe), AlertDialogBuilder.DialogButton.OK, AlertDialogEvent {
                            finish()
                        })
                        return@execute
                    }
