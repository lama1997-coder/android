package com.das.taxi.rider.activities.main
...
import com.das.taxi.common.activities.chargeAccount.ChargeAccountActivity
import com.das.taxi.common.activities.transactions.TransactionsActivity
import com.das.taxi.common.activities.travels.TravelsActivity
import com.das.taxi.common.interfaces.AlertDialogEvent
import com.das.taxi.common.location.MapHelper.centerLatLngsInMap
...
import com.das.taxi.common.utils.AlerterHelper.showInfo
import com.das.taxi.common.utils.AlerterHelper.showWarning
import com.das.taxi.common.utils.CommonUtils
import com.das.taxi.common.utils.DataBinder.setMedia
import com.das.taxi.common.utils.LocationHelper.Companion.DoubleArrayToLatLng
import com.das.taxi.common.utils.LocationHelper.Companion.LatLngToDoubleArray
import com.das.taxi.rider.R
import com.das.taxi.rider.activities.about.AboutActivity
import com.das.taxi.rider.activities.addresses.AddressesActivity
import com.das.taxi.rider.activities.coupon.CouponActivity
import com.das.taxi.rider.activities.looking.LookingActivity
import com.das.taxi.rider.activities.main.adapters.ServiceCategoryViewPagerAdapter
import com.das.taxi.rider.activities.main.fragments.ServiceCarousalFragment.OnServicesCarousalFragmentListener
import com.das.taxi.rider.activities.profile.ProfileActivity
import com.das.taxi.rider.activities.promotions.PromotionsActivity
import com.das.taxi.rider.activities.travel.TravelActivity
import com.das.taxi.rider.databinding.ActivityMainBinding
import com.das.taxi.rider.models.LocationWithName
import com.das.taxi.rider.models.OrderedService
import com.das.taxi.rider.models.RequestDTO
import com.das.taxi.rider.networking.socket.*
...
class MainActivity : RiderBaseActivity(), OnMapReadyCallback, OnServicesCarousalFragmentListener {
        ...
        binding.searchPlace.setOnMenuItemClickListener { item: MenuItem ->
            when (item.itemId) {
                R.id.action_favorites -> {
                    GetAddresses().executeArray<com.das.taxi.common.models.Address> {
                        when (it) {
    ...
    private fun setLocale(localeName: String) {
        ...
        preferences.language=localeName
...
//        startActivity(refresh)
    ...
    private fun onButtonFinalDestinationClicked() {
        ...
        CalculateFare(request.points).execute<CalculateFareResult> {
            when (it) {
                is RemoteResponse.Success -> {
                    Log.d("MapItInSuccess", it.toString())
                    minutesFromNow = 0
                ...
                is RemoteResponse.Error -> {
                    Log.d("MapItInError", it.toString())
                    it.error.showAlert(this)
                    goBackFromServiceSelection()
                }
            }
