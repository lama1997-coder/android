package com.das.taxi.driver.activities.statistics
...
import com.das.taxi.driver.databinding.ActivityStatisticsBinding
import com.das.taxi.driver.networking.socket.GetStats
import com.das.taxi.driver.networking.socket.QueryType
import com.das.taxi.driver.networking.socket.RequestPayment
import com.das.taxi.driver.networking.socket.StatisticsResult
...
class StatisticsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.emptyState.setStateDisplay(EmptyStateRecyclerView.STATE_EMPTY, ImageTextStateDisplay(this, com.das.taxi.common.R.drawable.empty_state, getString(R.string.empty_state_driver_earning_title), getString(R.string.empty_state_driver_earning_message)))
